...
const HERO_IMAGE = "https://cdn.poehali.dev/projects/5d86bdf0-caa1-415e-848e-18fef434f4ad/files/e7062710-1e7b-46fa-9617-fb4dcd4e9716.jpg";
...
const CATEGORIES = [
  {
    ...
    desc: "Нории, транспортёры, зерноочистительные машины, сепараторы, зерносушилки",
    count: "120+ позиций",
  ...
  },
  {
    ...
    desc: "Склады, ангары, любые металлоконструкции по вашим чертежам",
    count: "Под заказ",
    specs: ["Склады и ангары любых размеров", "Изготовление по чертежам заказчика", "Чёрный металл, оцинковка, нержавейка"],
  },
];
...
const DELIVERY_ITEMS = [
  ...
  },
  {
    icon: "Package",
    title: "Самовывоз",
    desc: "Со склада в Воронеже. Адрес и режим работы склада уточняйте у менеджера.",
  },
  {
    icon: "Clock",
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <div className="space-y-4 font-ibm text-muted-foreground leading-relaxed">
                <p>
                  Компания Сельхозмаркет готова предложить вам свежий взгляд и современные решения для вашего агробизнеса. В основе нашей работы лежит глубокое понимание потребностей современного сельского хозяйства. Мы знаем, как важно иметь доступ к качественной технике и оригинальным запчастям, чтобы обеспечить бесперебойную работу вашего предприятия и достичь максимальной урожайности.
                </p>
                <p>
                  Мы стремимся строить долгосрочные отношения с нашими клиентами, основанные на взаимном доверии, прозрачности и высоком качестве предоставляемых услуг.
                </p>
                <p>
                  Наша миссия — обеспечить аграриев всем необходимым для успешной работы, предлагая конкурентоспособные цены, широкий ассортимент и оперативное обслуживание. Мы готовы предложить вам как проверенное временем оборудование, так и новейшие разработки отрасли, а также широкий выбор запчастей для различных видов техники.
                </p>
                <p>
                  Присоединяйтесь к «Сельхозмаркет» и откройте для себя новый уровень сотрудничества в сфере агротехники! Мы уверены, что наше партнёрство будет продуктивным и взаимовыгодным.
                </p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              {[
                ...
                { icon: "BarChart2", title: "Склад в наличии", desc: "Большой ассортимент позиций на складе для оперативной отгрузки." },
              ...
              <table className="w-full">
                ...
                <tbody className="divide-y divide-border">
                  {[
                    ...
                    ["Самовывоз", "Воронеж", "В день заказа", "Бесплатно"],
                  ].map((row, i) => (
